...
const consumerAddress = "0x6BCB1a3F6be9E6DE3621e12a90312689c810A948"; // REPLACE this with your Functions consumer address
const subscriptionId = 53; // REPLACE this with your subscription ID
...
const makeRequestFuji = async () => {
  ...
  const source = fs
    .readFileSync(path.resolve(__dirname, "source_sports.js"))
    .toString();
  
  // met parameter and league id (28 = world cup 2022).
  const args = ["Teams", "28"];
