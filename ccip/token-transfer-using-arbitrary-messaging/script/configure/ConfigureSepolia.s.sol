...
contract ConfigureSepolia is BaseConfiguration {
    function run() external {
        // Create fork for Sepolia network
        ...
        // Get Sepolia configuration contract
        Configuration sepoliaConfig = Configuration(allChains[0].addresses.configuration);
        
        // Start broadcasting transactions
        vm.startBroadcast(deployerPrivateKey);
        
        // Set remote bridges for other chains
        setRemoteBridges(sepoliaConfig, "Sepolia", allChains);
        
        // Configure destination tokens specific to Sepolia
        configureSepoliaDestinationTokens(sepoliaConfig, allChains);
        
        // Stop broadcasting
        vm.stopBroadcast();
        
        console.log("Sepolia remote bridges set");
