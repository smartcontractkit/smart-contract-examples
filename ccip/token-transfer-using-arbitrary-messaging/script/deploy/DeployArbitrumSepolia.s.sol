...
contract DeployArbitrumSepolia is BaseDeployment {
    function run() external {
        // Get network configuration for ArbitrumSepolia
        NetworkConfig memory config = getNetworkConfig("ArbitrumSepolia");
        ...
        // Deploy all contracts for ArbitrumSepolia
        ...
        console.log("=== ArbitrumSepolia Deployment Complete ===");
    }
} 